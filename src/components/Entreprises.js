...
function Entreprises() {
    ...
    function getListeEntreprise() {
        Axios.get("https://pc-et-associe-node.herokuapp.com" + "/profilCompagnie", {
        }).then((response) => {
    ...
    function addNewEntreprise(nom, noRegistre, adresse, telephone, courriel) {
        Axios.post("https://pc-et-associe-node.herokuapp.com" + "/profilCompagnie", {
            nom: nom,
    ...
    function modifEntreprise(nom, noRegistre, adresse, telephone, courriel, noRegistreActuel) {
        Axios.put("https://pc-et-associe-node.herokuapp.com" + "/profilCompagnie", {
            nom: nom,
            noRegistre: noRegistre,
            adresse: adresse,
            telephone: telephone,
    ...
    function deleteEntreprise(noRegistre) {
        ...
        Axios.delete("https://pc-et-associe-node.herokuapp.com" + "/profilCompagnie", {
            data: {
